...
public class Tools {
     ...
     */
    public void showDialog(Activity activity, String title, String message, String negativeMessage, String positiveMessage, final com.klsf111.linghangbiao.activitys.back.DialogInterface anInterface) {
     ...
     */
    public void showDialog(Activity activity, String title, String message, int negativeMessage, int positiveMessage, final com.klsf111.linghangbiao.activitys.back.DialogInterface anInterface) {
        AlertDialog.Builder builder = new AlertDialog.Builder(activity);
        builder.setTitle(title);
        builder.setMessage(message);
