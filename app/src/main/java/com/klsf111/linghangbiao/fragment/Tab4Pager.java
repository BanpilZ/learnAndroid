...
import com.klsf111.linghangbiao.activitys.utils.ParseJson;
import com.klsf111.linghangbiao.activitys.utils.TaskUtil;
import com.klsf111.linghangbiao.activitys.adapter.RecyclerAdapter;
        ...
        fragment_tab3_btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(fragment_tab3_edt_1.getText().toString())) {
                    tools.showDialog(getActivity(), "提示", "请输入发送内容", null, "确定", new com.klsf111.linghangbiao.activitys.back.DialogInterface() {
                        @Override
