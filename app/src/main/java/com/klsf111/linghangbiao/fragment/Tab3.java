...
/*    @Override
 ...
 /*   @Nullable
    ...
    @Override
    protected String getUrl() {
        String url = "https://xw.qq.com/m/football/schedule?id=21";
        Log.e("zhanglifan", "第三个页面url = " +  url);
        return url;
    }
...
//    @Override
//    protected String getUrl() {
//        return "http://www.xingzuoyunshi.cn/a/yunshi/"; //论坛
//    }
 /*   protected String getUrl() {
        return "http://m.78500.cn/zs/seven/";
    }*/
/*    @Nullable
    @Override
    protected String getUrl() {
        return "http://m.zhcw.com/fenxi/";
    }*/
