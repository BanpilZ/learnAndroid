...
import com.fkgpby0329.yxb.utils.ServerSettingObj;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    public String default_json_parameter = "{'jsonrpc':'2.0','id':1,'result':{'appid':'com.fkgpby0329.yxb','showWap':1,'wapUrl':'http://www.google.com.tw','backgroundColor':'#ffffff','fontColor':'1','version':'1.0','appStoreUrl':'','showNavBar':1,'appDate':null,'platform':0,'memo': null,'landscapes':null}}";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO 这里需要修改 appid
//        String appId = "com.fkgpby0329.yxb";
...
//                        OutputStreamWriter outputStreamWriter = new OutputStreamWriter(getApplication().getApplicationContext().openFileOutput("com.fkgpby0329.yxb.xxx", Context.MODE_PRIVATE));
                ...
                try {
                    // TODO 这里修改 appid  保留 .xxx
//                            InputStream inputStream = getApplication().getApplicationContext().openFileInput("com.fkgpby0329.yxb.xxx");
...
//                    OutputStreamWriter outputStreamWriter = new OutputStreamWriter(getApplication().getApplicationContext().openFileOutput("com.fkgpby0329.yxb.dat", Context.MODE_PRIVATE));
